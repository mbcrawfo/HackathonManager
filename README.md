...
This [configuration](./compose.yml) uses the .Net web application to serve the React SPA files in a single container.  The SPA is always served by the .Net app.

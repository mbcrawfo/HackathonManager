...
public static class ErrorCodes
{
    ...
    public const string InvalidPaginationCursor = "validation_invalid_pagination_cursor";
    ...
    public const string MustBeInRange = "validation_must_be_in_range";
    public const string MustBeNull = "validation_must_be_null";
